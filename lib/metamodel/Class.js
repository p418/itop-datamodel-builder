...
Class.prototype.addNaming = function(field)
{
	this.getProperty('naming').push(field);
	return this;
};

Class.prototype.addReconciliation = function(field)
{
	this.getProperty('reconciliation').push(field);
	return this;
};
