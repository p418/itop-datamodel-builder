...
module.exports = AttributeExternalField;


/**
 *
 * @todo implements AttributeExternalField Class
 * @constructor
 */
function AttributeExternalField()
{
	Attribute.call(this);
...
Util.inherits(AttributeExternalField, Attribute);
